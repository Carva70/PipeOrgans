...
import com.finchy.pipeorgans.block.pipes.generic.RegalBlockEntity;
...
public class VoxHumanaBlockEntity extends RegalBlockEntity {
    public VoxHumanaBlockEntity(BlockPos pos, BlockState blockState) {
        super(pos, blockState, AllBlockEntities.VOXHUMANA_BLOCK_ENTITY);
    }
